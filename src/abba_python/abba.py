...
def get_java_dependencies():
    ...
    return ['net.imagej:imagej:2.15.0',
            ...
            'ch.epfl.biop:ImageToAtlasRegister:0.9.11',
            'ch.epfl.biop:bigdataviewer-biop-tools:0.10.9',
            'sc.fiji:bigdataviewer-playground:0.10.10',
            'sc.fiji.bigdataviewer:bigdataviewer-playground-display:0.4.3',
            'sc.fiji:bigwarp_fiji:9.1.3',
            'net.imglib2:imglib2-realtransform:4.0.2',
            'com.formdev:flatlaf:3.5',
            'ch.epfl.biop:bigdataviewer-image-loaders:0.8.9',
            'ch.epfl.biop:atlas:0.2.4',
            ...
            'org.janelia.saalfeldlab:n5-ij:4.2.1-fix1',
            # 'org.janelia.saalfeldlab:n5 - imglib2:',
            'org.janelia.saalfeldlab:n5-aws-s3:4.2.0',
            'org.janelia.saalfeldlab:n5-google-cloud:4.1.0',
            'org.janelia.saalfeldlab:n5-viewer_fiji:6.1.1',
            'org.janelia.saalfeldlab:n5-zarr:1.3.4',
            'org.janelia.saalfeldlab:n5-universe:1.6.0',
            ]
